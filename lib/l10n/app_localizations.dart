...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'psnAccountId': 'PSN Account ID (Base64)',
      'psnAccountIdHint': 'Leave empty to use default',
      'psnAccountIdHelp': 'How to get PSN Account ID?',
      'psnAccountIdHelpUrl': 'https://github.com/thestr4ng3r/chiaki/wiki/Getting-Started#obtaining-your-psn-accountid',
      'invalidPsnAccountId': 'Invalid PSN Account ID format. Must be Base64 encoded 8 bytes.',
      'psnAccountIdSaved': 'PSN Account ID saved successfully',
    ...
    'zh': {
      ...
      'psnAccountId': 'PSN 账户 ID (Base64)',
      'psnAccountIdHint': '留空使用默认值',
      'psnAccountIdHelp': '如何获取 PSN Account ID?',
      'psnAccountIdHelpUrl': 'https://github.com/thestr4ng3r/chiaki/wiki/Getting-Started#obtaining-your-psn-accountid',
      'invalidPsnAccountId': 'PSN Account ID 格式无效。必须是 Base64 编码的 8 字节数据。',
      'psnAccountIdSaved': 'PSN Account ID 保存成功',
